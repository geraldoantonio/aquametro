...
const MESSAGES = {
  "pt-BR": {
    ...
    "form.intPlaceholder": "1234",
    "form.decPlaceholder": "000",
    "form.decHint": "A parte vermelha (litros) é opcional — a conta usa só os m³.",
    "form.errRequired": "Preencha a data e o valor do medidor.",
    "form.errIncreasing": "O hidrômetro só aumenta — deve ser ≥ {min} m³.",

    "ocr.button": "Ler com a câmera",
    "ocr.title": "Mire o visor do hidrômetro",
    "ocr.hint": "Encaixe os dígitos dentro da moldura e toque para capturar.",
    "ocr.capture": "Capturar",
    "ocr.cancel": "Fechar",
    "ocr.loadingEngine": "Preparando o leitor (só na primeira vez)…",
    "ocr.processing": "Lendo os dígitos…",
    "ocr.badge": "Lido por OCR",
    "ocr.valueLabel": "Leitura reconhecida (revise antes de usar)",
    "ocr.decHint": "O OCR lê só os m³ (preto). Ajuste os litros (vermelho) à mão, se quiser.",
    "ocr.goodConfidence": "confiança {pct}%",
    "ocr.lowConfidence": "confiança {pct}% · revise os dígitos em vermelho",
    "ocr.use": "Usar esta leitura",
    "ocr.retry": "Tentar de novo",
    "ocr.manual": "Digitar manualmente",
    "ocr.errNoDigits": "Não consegui ler os dígitos. Aproxime, evite reflexo e tente de novo.",
    "ocr.errCamera": "Não foi possível acessar a câmera. Verifique a permissão do navegador.",
    "ocr.errEngine": "Falha ao carregar o leitor. É preciso conexão só na primeira vez.",
